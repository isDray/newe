...
<div class="col-lg-10 col-lg-offset-1">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    <form  id='accform' onsubmit='return false' role="form" method="POST" action="{{ url('/edit/origin_type_manager_new_do')}}" enctype="multipart/form-data">
...
$(function(){
    ...
    $('button[type=submit]').click(function(){
        ...
        if( $("#accform").valid() ){
            ...
            $.ajax({
                method: "POST",
                url: "{{ url('edit/origin_manager_new_do')}}",
                data:formData,
                contentType: false,   
                processData: false, 
                statusCode: {
