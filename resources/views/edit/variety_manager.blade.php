...
<div class="col-lg-2 col-lg-offset-9 text-right slf_topac">
    <a href="{{url('/edit/variety_manager_new')}}">
        <button type="button" class="btn btn-success glyphicon-plus">新增葡萄品種</button>
    </a>
</div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        @foreach ($variety_manager as $account)
                        <tr>
                            <td>{{ $account -> id }}</td>
                            <td>{{ $account -> name }}</td>
                            <td>
                            ...
                            <td>{{ $account -> sort }}</td>
                            <td>
                                <a href="{{url('/edit/variety_manager_edit/'.$account -> id)}}">
