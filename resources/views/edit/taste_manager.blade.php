...
<div class="col-lg-2 col-lg-offset-9 text-right slf_topac">
    <a href="{{url('/edit/taste_manager_new')}}">
        <button type="button" class="btn btn-success glyphicon-plus">新增口感</button>
    </a>
</div>
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <!-- 列表內容 -->
                        @foreach ($Taste_manager as $account)
                        <tr>
                            <td>{{ $account -> id }}</td>
                            <td>{{ $account -> name }}</td>
                            <td>
                            ...
                            <td>
                                <a href="{{url('/edit/taste_manager_edit/'.$account -> id)}}">
