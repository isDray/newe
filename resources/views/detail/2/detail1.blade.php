...
"薩蘭多海灘"夏多內白酒
            ...
            <img  id='wwine_pic' src="{{ url('image/goods/white01.png')}}">
            <img  id='pwine_pic' src="{{ url('image/goods/white01.png')}}"
...
"薩蘭多海灘"夏多內白酒
            ...
            <div id='txt_des' class='col-md-10 col-md-offset-0 col-sm-8 col-sm-offset-2 col-xs-8  col-xs-offset-2'>
              葡萄先行輕微壓碎，短暫浸漬於冷水後持續輕柔按壓，然後在溫控15~17°C的環境中進行發酵；先置於不銹鋼容器內4個月，再注入瓶中封存2個月。
    酒液呈現麥稈黃帶淺綠色，強烈的水果芳香，酒體飽滿熱情；清新的味道，柔潤細緻、愉悅和諧。
            </div>
            
            <div id='txt_ifo' class='col-sm-12 col-sm-offset-0 col-xs-12  col-xs-offset-0'>
酒莊名稱: CANTINE PAOLO LEO S.R.L.
                  義大利保羅.列歐酒莊 <br>
葡萄品種: 100%CHARDONNAY(夏多內/霞多麗) <br>
酒品等級: IGT <br>
酒精濃度: 13% <br>
容量: 750ml <br>
適飲溫度: 12℃ <br>
推薦搭配料理: 可搭配各式海鮮料理，尤其最適合燒烤魚 <br>
            </div>
