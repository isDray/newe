...
"史騰二號"麗波拉姬亞拉白葡萄酒
            ...
            <img  id='wwine_pic' src="{{ url('image/goods/white03.png')}}">
            <img  id='pwine_pic' src="{{ url('image/goods/white03.png')}}"
...
每年十月前十日以手工摘採葡萄並去梗後，以低溫浸泡24小時，再以溫控16 - 18°C下於不銹鋼桶內進行發酵，六個月後除渣裝瓶。
     酒體呈現麥稈黃中帶淺綠色；有野花、青蘋果及檸檬葉等令人舒適的香味；口感年輕、清新且優雅。
...
葡萄品種: 100% Ribolla Gialla (麗波拉姬亞拉) <br>
酒品等級: DOC <br>
酒精濃度 : 12.5% <br>
容量 : 750ml <br>
適飲溫度: 11℃ <br>
推薦搭配料理: 非常適合當開胃酒，與各式冷熱海鮮料理搭配極佳 <br>
            </div>
