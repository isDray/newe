...
GALASSO VILLA GALASSO VETICA
MONTEPULCIANO D’ABRUZZO DOC <br>
"葛拉索山莊"蒙特普爾恰諾紅葡萄酒
            </div>
            <img  id='wwine_pic' src="{{ url('image/goods/red06.png')}}">
            <img  id='pwine_pic' src="{{ url('image/goods/red06.png')}}"
...
"葛拉索山莊"蒙特普爾恰諾紅葡萄酒
    ...
    葡萄帶皮在溫控28°C的不鏽鋼桶內先行發酵15天，再置於橡木桶中經過12個月的熟成。酒液呈現紅寶石色，帶有濃郁的莓果香氣，單寧纖細、口感柔順且細緻。
            </div>
