...
NERIMATTI
RISERVA SALICE SALENTINO DOC <br>
"内瑞馬提"薩利切薩倫帝諾陳釀紅葡萄酒 
            </div>
            <img  id='wwine_pic' src="{{ url('image/goods/red14.png')}}">
            <img  id='pwine_pic' src="{{ url('image/goods/red14.png')}}"
...
在黎明前的幾小時開始採摘葡萄，採收後去梗並輕微的擠壓葡萄，使葡萄皮有些許的破損。隨後溫度控制在攝氏18度下浸泡 12到15天，並在恆溫攝氏25度下進行約8天的蘋果酸乳酸發酵程序。在不鏽鋼容器中經過18個月的發酵後，轉置於大橡木桶裡陳釀約6個月，再放置瓶中約6個月後上市。
    酒體呈現深紅寶石色，並隨著光線反射變化出深橙色。有著紅色漿果和成熟果實的獨特香氣，帶有一絲明顯但令人著迷的香草植物清香味。入口後帶出滿口濃郁的香氣與非常細緻的單寧感，持久綿長的果乾甜和酒體本身的甘味在味覺上達到完美的平衡。
            </div>
            
            <div id='txt_ifo' class='col-sm-12 col-sm-offset-0 col-xs-12  col-xs-offset-0'>
酒莊名稱: CANTINE PAOLO LEO S.R.L.
                 義大利保羅.列歐酒莊 <br>
葡萄品種: Negroamaro(尼古阿馬羅)、
                   Malvasia Nera(黑瑪爾維薩) <br>
酒品等級: DOC <br>
酒精濃度: 14% <br>
容量: 750ml <br>
適飲溫度: 18℃ <br>
