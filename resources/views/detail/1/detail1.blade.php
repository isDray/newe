...
<div id='detail_area' class='col-md-12 col-sm-12 col-xs-12'>
    ...
    <div class="col-md-9"></div>
        ...
        <div id='detail_pic' class='col-md-3 col-md-offset-0 col-sm-12 col-xs-12'>
            ...
            <img  id='wwine_pic' src="{{ url('image/goods/red01.png')}}">
            <img  id='pwine_pic' src="{{ url('image/goods/red01.png')}}"
        ...
        <div id='detail_txt' class='col-md-3 col-md-offset-1 col-sm-12 col-xs-12'>
            ...
            Bricco Maiolica以莊園內的Nebbiolo葡萄，生產出了一款年輕、雅致且柔順的葡萄酒。本葡萄酒先在不鏽鋼桶中釀製約10個月，而後在每年七月裝瓶。酒體顏色為寶石紅，果香中帶有些微覆盆子、草莓與紅醋栗香氣，口感柔順、清新且纖細，帶有輕微的丹寧。
            </div>
            
            <div id='txt_ifo' class='col-sm-12 col-sm-offset-0 col-xs-12  col-xs-offset-0'>
                酒莊名稱: AZ. AGR. BRICCO MAIOLICA S.S.A <br>
                義大利布里柯.瑪若利卡酒莊 <br>
                葡萄品種: 100%Nebbiolo(內比奧羅) <br>
                酒品等級: DOC <br>
                酒精濃度: 13% <br>
                容量: 750ml <br>
                適飲溫度: 18℃ <br>
                建議醒酒時間: 30分鐘 <br>
                推薦搭配料理: 家常義式料理與各式肉類料理 <br>
            </div>
