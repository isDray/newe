...
<div id='detail_area' class='col-md-12 col-sm-12 col-xs-12'>
    ...
    <div class="col-md-9"></div>
        ...
        <div id='detail_pic' class='col-md-3 col-md-offset-0 col-sm-12 col-xs-12'>
            ...
            <img  id='wwine_pic' src="{{ url('image/goods/red05.png')}}">
            <img  id='pwine_pic' src="{{ url('image/goods/red05.png')}}"
    ...
    每年九月的第二個禮拜是葡萄採收的時節。葡萄在嚴格的溫控下於不鏽鋼槽內先行發酵，再存放於法國橡木桶內進行18~24個月的熟成(50%新桶、50%舊桶)，裝瓶再陳釀12個月。酒體呈現寶石紅，富有紫羅蘭、森林野果及黑莓香氣，口感相當的柔順高雅，味覺結構良好，尾韻圓潤亙久。
            </div>
            
            <div id='txt_ifo' class='col-sm-12 col-sm-offset-0 col-xs-12  col-xs-offset-0'>
酒莊名稱: FATTORIA DI GRIGNANO
                義大利格里納羅酒莊 <br>
葡萄品種: 90% Merlot(梅洛) <br>
                 10% Petit Verdot(小維鐸) <br>
酒品等級: IGT <br>
酒精濃度: 14.5% <br>
容量: 750ml <br>
適飲溫度: 18℃ <br>
