...
GALASSO CORNO GRANDE PREMIUM
MONTEPULCIANO D’ABRUZZO DOC <br>
"大角山羊"蒙特普爾恰諾紅葡萄酒 
            </div>
            <img  id='wwine_pic' src="{{ url('image/goods/red07.png')}}">
            <img  id='pwine_pic' src="{{ url('image/goods/red07.png')}}"
...
"大角山羊"蒙特普爾恰諾紅葡萄酒 
    ...
    葡萄帶皮在不鏽鋼桶內、溫控28°C下進行發酵15天，接著在大型橡木桶內存放12個月後，裝入瓶中繼續熟成。酒體為深紅寶石色；其氣味中有強烈的紅色水果香，並帶有梅子與黑莓酸的味痕；口感柔順且精緻、單寧纖細且持久。
            </div>
