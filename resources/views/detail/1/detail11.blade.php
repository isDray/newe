...
"紅衣主教"普里米蒂沃紅葡萄酒
            ...
            <img  id='wwine_pic' src="{{ url('image/goods/red11.png')}}">
            <img  id='pwine_pic' src="{{ url('image/goods/red11.png')}}"
...
"紅衣主教"普里米蒂沃紅葡萄酒
    ...
    在日出前就採摘完畢，溫度控制在攝氏25度發酵8-10天。放置在美國橡木桶3個月隨後移置不鏽鋼桶內再陳釀6個月。
    酒體呈現寶紅色，帶有濃郁的花香與令人喜愛的適量辛辣感；整體口感平衡令人印象深刻，結構良好並尾韻持久。
            </div>
