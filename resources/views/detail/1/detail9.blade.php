...
"魅紫"尼古阿馬羅紅葡萄酒
            ...
            <img  id='wwine_pic' src="{{ url('image/goods/red09.png')}}">
            <img  id='pwine_pic' src="{{ url('image/goods/red09.png')}}"
...
"魅紫"尼古阿馬羅紅葡萄酒
    ...
    酒體呈現強烈的紅色色調，並帶有紫羅蘭色般的映影。氣味圓潤如紅醋栗果醬與覆盆子般，具有獨特性的芳香。味道濃郁、平衡且清新。
            </div>
