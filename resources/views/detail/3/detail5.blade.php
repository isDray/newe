...
"瑪拉內洛二號(金)"特甘型普錫科氣泡酒
            ...
            <img  id='wwine_pic' src="{{ url('image/goods/sp04.png')}}">
            <img  id='pwine_pic' src="{{ url('image/goods/sp04.png')}}"
...
"瑪拉內洛二號(金)"特甘型普錫科氣泡酒
            ...
            <div id='txt_des' class='col-md-10 col-md-offset-0 col-sm-8 col-sm-offset-2 col-xs-8  col-xs-offset-2'>
              將Glera葡萄輕柔擠壓，首先使用傳統白葡萄酒釀造方式，將葡萄置於溫控下的不鏽鋼槽內進行發酵；接下來使用夏馬槽法(Charmat method)，在加壓鋼桶中加入嚴選酵母，於溫控中進行自然發酵。
    酒體呈現金黃麥稈色，氣泡細緻且持久；帶有香醇濃郁的蘋果果香與花香，入口後清新且均衡，帶有水果與杏仁味道。
            </div>
            
            <div id='txt_ifo' class='col-sm-12 col-sm-offset-0 col-xs-12  col-xs-offset-0'>

酒莊名稱: MARANELLO WINES SOC. COOP.
                   義大利瑪拉內洛酒莊 <br>
...
1950年代Aimo Barbieri先生開始了第一個家族事業：Lambrusco葡萄榨汁工廠：從Modena和Reggio Emilia周圍地區數百名小葡萄種植者手中收集Lambrusco葡萄並予以加工。到了1983年，Barbieri家族開始收購北義與中義的葡萄園。1990年代新一代的家族成員加入後擴充了裝瓶服務，並且購入了大型裝瓶工廠。今日，由Bruno Barbieri建立總部位於Modena的新公司-Maranello Wines，專注於生產並銷售“Maranello”品牌下的氣泡酒，以及“Cantina Del Duca”品牌下的葡萄酒。
    Maranello Wines尊重傳統但也因應市場潮流，致力於創新且特色化產品，滿足客戶任何客製化的需求，讓世界各地的葡萄酒愛好者都可以享受到義大利美酒佳釀。
