...
"2014年份"特甘型氣泡酒
            ...
            <img  id='wwine_pic' src="{{ url('image/goods/sp02.png')}}">
            <img  id='pwine_pic' src="{{ url('image/goods/sp02.png')}}"
...
"2014年份"特甘型氣泡酒
            ...
            <div id='txt_des' class='col-md-10 col-md-offset-0 col-sm-8 col-sm-offset-2 col-xs-8  col-xs-offset-2'>
              釀造時採全程溫控，經輕柔擠壓葡萄程序後發酵與過濾，並使用不鏽鋼缸槽發酵法/義大利發酵法(Charmat method)釀造至少3個月後才出產。
    Millesimato中蘋果、白梨、杏桃與山楂花的花果香氣令品嘗過之人驚艷不已，種種花果香混合而成的口感不但清新舒爽、雅緻芳醇且氣泡細緻長久。
            </div>
            
            <div id='txt_ifo' class='col-sm-12 col-sm-offset-0 col-xs-12  col-xs-offset-0'>
酒莊名稱: VINICOLTURA LE RUGHE S.A.S.
                  義大利列魯格酒莊 <br>
葡萄品種: 100%Glera(格雷拉) <br>
酒品等級:
酒精濃度 : 11% <br>
容量 : 750ml <br>
適飲溫度: 4℃ <br>
...
Le Rughe酒莊位於距離義大利威尼斯北方五十公里遠的科內利亞諾(Conegliano)丘陵地帶，酒莊名代表著千年古老傳統的價值觀，而這些珍貴的價值觀是世世代代Conegliano DOCG(保證法定產區)所依賴的碁石。
    Le Rughe酒莊擁有的葡萄園在當地已有兩百年的歷史，五十年前Roberto Sandro先生的家族購入後，努力地在義大利當地與世界各地推廣其品牌與產品。Prosecco氣泡酒是一款世界相當知名且獨特的義大利酒款，在經過這麼多年後，Le Rughe在Conegliano和San Pietro di Feletto之間的二十公頃葡萄園裡發展出了最佳釀酒技術，並在生產過程中使用全套現代不鏽鋼設備器材，由經驗豐富的農藝學家負責監督與生產製造。目前除了Prosecco氣泡酒系列外，Le Rughe也生產義大利DOC(法定產區)級與其他酒款，行銷全世界。
