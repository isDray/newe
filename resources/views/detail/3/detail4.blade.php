...
"瑪拉內洛一號(金)"莫斯卡托甜氣泡酒
            ...
            <img  id='wwine_pic' src="{{ url('image/goods/sp03.png')}}">
            <img  id='pwine_pic' src="{{ url('image/goods/sp03.png')}}"
...
"瑪拉內洛一號(金)"莫斯卡托甜氣泡酒
            ...
            <div id='txt_des' class='col-md-10 col-md-offset-0 col-sm-8 col-sm-offset-2 col-xs-8  col-xs-offset-2'>
              將Moscato葡萄輕柔擠壓，首先使用傳統白葡萄酒釀造方式，將葡萄置於溫控下的不鏽鋼槽內進行發酵；接下來使用夏馬槽法(Charmat method)，在加壓鋼桶中加入嚴選酵母，於溫控中進行自然發酵。
    酒體呈現金黃麥稈色，氣泡細緻且持久；濃郁而精緻的花香、白色水果與香草香氣，雖然在杯中不斷的變化，但總是能保持完美的平衡是其特色。
            </div>
